...
cfg.normalized = 1; % use here 0 if you want relative and 1 if you want absolute
flow_vs_nflow_60s_1r = tfr_comparisonNN(WF_FLOW_60s_1r,WF_NFLOW_60s_1r,cfg); % here you can test baselined and no-baselined (explore)
